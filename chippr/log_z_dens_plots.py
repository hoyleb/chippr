...
s_stk, w_stk, a_stk, c_stk, d_stk, l_stk = '--', 2., 1., 'r', '--', 'Stacked '#[(0, (2, 2))], 'Stacked '
s_map, w_map, a_map, c_map, d_map, l_map = '--', 1., 1., 'r', '-.', 'Modes (MAP)'#[(0, (2, 1))], 'Modes '
s_exp, w_exp, a_exp, c_exp, d_exp, l_exp = '--', 1., 1., 'r', ':', 'Means '#[(0, (1, 2))], 'Means '
