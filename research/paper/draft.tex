...
The tests presented here are conducted with samples of $N = 10^{4}$ with 
...
In comparison with use of the stacked estimator of the redshift distribution 
function, the hierarchical approach is computationally expensive.  In a future 
revision, the \chippr code will be optimized for speed and resource efficiency. 
 At this stage, we establish scaling behavior to project the expense in terms 
